...
class DatabaseConn {	
  ...
  public function dbOpen(){
    ...
    try {
      ...
      $dbHost = 'localhost';
      $dbName = 'mbatterson';//this will be your WCC username
      $dbUsr = 'mbatterson';//this will be your WCC username
      $dbPass = '9wbH6BZWq3bw';//this will be the password found in the video.
